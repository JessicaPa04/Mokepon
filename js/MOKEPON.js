...
let hipodogeEnemigo = new Mokepon('Hipodoge', './assets/HIPODOGE.png' , 5, './assets/hipodogee.png')
let capipepoEnemigo = new Mokepon('Capipepo', './assets/CAPIPEPO.png', 5, './assets/capipepoe.png')
let ratigueyaEnemigo = new Mokepon('Ratigueya', './assets/RATIGUEYA.png', 5, './assets/ratigueyae.png')
...
function revisarColision(enemigo) {
    ...
    const arribaMascosta = mascotaJugadorObjeto.y
    const abajoMascota = mascotaJugadorObjeto.y + mascotaJugadorObjeto.alto
    const derechaMascota = mascotaJugadorObjeto.x + mascotaJugadorObjeto.ancho
    const izquierdaMascota = mascotaJugadorObjeto.x

    if(abajoMascota < arribaEnemigo ||
        arribaMascosta > abajoEnemigo ||
